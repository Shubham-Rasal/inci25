  ...
  return (
    <div id="merch" className="flex overflow-hidden flex-col px-20 py-32 max-md:mt-10 lg:w-4/5 lg:mx-auto max-md:px-5 max-md:py-24">
      ...
      <div className="flex overflow-hidden flex-col mt-14 w-full border border-yellow-600 border-solid max-md:mt-10 max-md:max-w-full">
        ...
        <div className="lg:flex w-full items-center justify-center self-center mx-auto mt-6">
              ...
              <div className="flex gap-5 max-md:flex-col">
                ...
                <div className="flex flex-col ml-5 w-[59%] max-md:ml-0 max-md:w-full">
                  <div className="flex flex-col grow text-orange-200 max-md:mt-10 max-md:max-w-full">
                    <div className="flex flex-col justify-center max-md:max-w-full px-4 text-center">
                    ...
                    <ResponsiveImage
                      ...
                      className="object-contain mt-12 max-w-full aspect-[5.1] max-md:mt-10"
                    />
                    </div>
                  </div>
                </div>
