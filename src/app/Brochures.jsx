  ...
  return (
    <div className="relative flex flex-col items-center justify-center py-20 px-4 bg-[#1E0E03] overflow-hidden">
      ...
      <div className="relative z-10">
        <h1 className="text-center text-white text-5xl font-bold mb-6 uppercase tracking-widest">Brochures</h1>
        ...
        <div className="flex flex-col gap-8 w-full items-center">
          <BrochureButton text="EVENT BROCHURE" previewImage="/brochure-preview.png" />
        </div>
      </div>
    </div>
  )
